<div wire:ignore.self class="modal fade" id="addoutgoingbookModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="p-4 modal-content p-md-5">
            <button type="button" class="btn-close btn-pinned" data-bs-dismiss="modal" aria-label="Close"></button>
            <div class="modal-body p-md-0">
                <div class="mb-4 text-center mt-n4">
                    <h3 class="pb-1 mb-2">اضافة الكتاب الصادر</h3>
                    <p>نافذة الأضافة </p>
                </div>
                <hr class="mt-n2">
                <div wire:loading.remove wire:target="store, GetOutgoingbook">
                    <form id="addoutgoingbookModalForm" autocomplete="off">
                        <div class="row">
                            <div class="col-8">
                                <div Class="row">
                                    <div class="mb-3 col">
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <input wire:ignore wire:model.defer='book_date' type="text"
                                                id="addOutgoingbookbook_date" placeholder="تاريخ الكتاب"
                                ...
                                <div class="row">
                                    <div class="mb-3 col" wire:key="select">
                                        <div class="form-floating form-floating-outline">
                                            <select wire:model.defer='recipient_id' id="addOutgoingbookrecipient_id"
                                            ...
                                            <label for="addOutgoingbookrecipient_id">الجهة المرسل إليها</label>
                                        </div>
                                        @error('recipient_id')
                                            <small class='text-danger inputerror'>{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="mb-3 col">
                                        <div class="form-floating form-floating-outline">
                                            <select wire:model.defer='related_book_id'
                                                id="addOutgoingbookrelated_book_id"
