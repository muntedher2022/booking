                ...
                <div class="mb-4 text-center mt-n4">
                    <div class="text-center mb-4">
                        <h3 class="fw-bold mb-2">
                            <span class="text-primary">اضافة</span> تتبع جديد
                        </h3>
                        <p class="text-muted">
                            <i class="mdi mdi-office-building-outline me-1"></i>
                            قم بإدخال تفاصيل التتبع في النموذج أدناه
                        </p>
                    </div>
                </div>
                <hr class="mt-n2">
                    ...
                    <div class="row row-cols-1  ">
                        <div class="col mb-3">
                            <div Class="row">
                                ...
                                <div class="mb-3 col">
                                    <div class="form-floating form-floating-outline">
                                        <input wire:model.defer='page_name' type="text" id="modalTrackinpage_name"
