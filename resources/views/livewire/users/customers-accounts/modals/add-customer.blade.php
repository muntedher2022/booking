            ...
            <div class="modal-body p-md-0 mt-n4">
                <div class="text-center mb-4">
                    <h3 class="fw-bold mb-2">
                        <span class="text-primary">اضافة</span> عميل جديد
                    </h3>
                    <p class="text-muted">
                        <i class="mdi mdi-account-tie me-1"></i>
                        قم بإدخال بيانات العميل في النموذج أدناه
                    </p>
                </div>
                ...
                <form id="adduserForm" class="pt-2 row" onsubmit="return false" autocomplete="off">
                    ...
                    <div class="mb-3 row ">
                        <div class="col-6">
                            <div class="form-floating form-floating-outline">
                                <select wire:model.defer='UserRoles' id="UserRoles" class="select2 form-select h-100"
                    ...
                    <div class="mb-3 col-12 text-start" style="direction: rtl;">
                        <div class="p-3" style="background: rgba(99, 102, 241, 0.05); border: 1px solid rgba(99, 102, 241, 0.2); border-radius: 10px;">
                            <div class="form-check form-switch d-flex align-items-center justify-content-between p-0 m-0">
                                <div>
                                    <label class="form-check-label fw-bold text-dark d-block" for="add_customer_is_totp_required" style="font-size: 0.95rem;">
                                ...
                                <input wire:model.defer="is_totp_required" class="form-check-input ms-0 me-3" type="checkbox" id="add_customer_is_totp_required" style="width: 2.8em; height: 1.5em; cursor: pointer;">
                            </div>
                        </div>
                    </div>
