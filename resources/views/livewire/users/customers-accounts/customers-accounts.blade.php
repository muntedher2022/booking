                    ...
                    <div class="d-flex align-items-center gap-3">
                        <div class="avatar">
                            <div class="rounded avatar-initial bg-label-primary">
                                <div class="mdi mdi-account-group mdi-24px"></div>
                            </div>
                        </div>
                        <div></div>
                        <div>
                            <h5 class="mb-1 text-dark fw-semibold d-flex align-items-center gap-1">
                                {{ $Users->count() }}
                                <small class="text-muted fw-normal">عميل</small>
                            </h5>
                            <p class="mb-0 text-muted small">إجمالي العملاء المسجلين</p>
                        </div>
                    </div>
                </div>
            </div>
