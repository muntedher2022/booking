    ...
    <script>
        ...
        $(document).ready(function() {
            function initFlatpickr(selector, eventName) {
                $(selector).flatpickr({
            dateFormat: "Y/m/d", // تنسيق التاريخ (سنة/شهر/يوم)
            allowInput: true, // تمكين الكتابة اليدوية
            placeholder: 'يوم / شهر / سنة',
            yearSelectorType: "dropdown", // تمكين قائمة منسدلة للسنوات
            minDate: "1900-01-01", // تحديد الحد الأدنى للتاريخ
            maxDate: "today",
