	...
	<ul class="py-1 menu-inner">
		@foreach ($menuData[0]->menu as $menu)
			...
			@if (isset($menu->menuHeader))
				<li class="mt-4 menu-header fw-light">
			...
			@else
				...
				@php
					...
					$currentRouteNameWithPrefix = trim(Route::current()->getPrefix(), '/');
					...
					elseif (isset($menu->submenu)) {
						if (gettype($menu->slug) === 'array') {
							...
							else if (str_contains($currentRouteNameWithPrefix,$menu->slug) and strpos($currentRouteNameWithPrefix,$menu->slug) === 0) {
								$activeClass = 'active open';
							}
						}
					}
